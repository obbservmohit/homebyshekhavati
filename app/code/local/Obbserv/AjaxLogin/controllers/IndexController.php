...
class Obbserv_AjaxLogin_IndexController extends Mage_Core_Controller_Front_Action
{
    ...
    public function createAction()
    {
        ...
        try {
            ...
            if ($e->getCode() === Mage_Customer_Model_Customer::EXCEPTION_EMAIL_EXISTS) {
                ...
                $message = $this->__('There is already an account with this email address. If you are sure that it is your email address, <a href="javascript:void(0);" data-target="#myModalforgotpass" data-dismiss="modal" data-toggle="modal">click here</a> to get your password and access your account.', $url);
    ...
    public function forgotpasswordAction()
    {
        ...
        if ($email) {
            if (!Zend_Validate::is($email, 'EmailAddress')) {
                ...
                if ($customer->getId()) {
                    try {
                        ...
                        if (method_exists($customerHelper, 'generateResetPasswordLinkToken')) {
                            ...
                            $result['message'] = Mage::helper('customer')->__('A new password has been sent to your registered email.');
                        } else {
                            // 1.6.0.x and earlier
                ...
                if (!isset($result['message']) && (!$customer->getId())) {
